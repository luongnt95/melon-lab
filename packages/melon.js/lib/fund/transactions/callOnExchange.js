...
const callOnExchange = async (
    ...
    fundContract,
        exchangeAddress,
        method,
        orderAddresses: [maker = "0x0000000000000000000000000000000000000000", taker = "0x0000000000000000000000000000000000000000", makerAsset, takerAsset, feeRecipient = "0x0000000000000000000000000000000000000000"],
        orderValues: [
            makerQuantity,
            takerQuantity,
            makerFee = "0",
    ...
    const args = [
        ...
        [
            toProcessable(config, makerQuantity, makerAsset, false).toString(),
            toProcessable(config, takerQuantity, takerAsset, false).toString(),
            makerFee,
            takerFee,
            timestamp,
            salt,
            toProcessable(config, fillTakerTokenAmount, takerAsset, false).toString(),
            dexySignatureMode,
        ],
