  ...
  melonAssetSymbol,
    ...
    <Card id="parosContribution" centered>
      <Card.Content>
        ...
        <p style={{ fontSize: '1.1em' }}> You are about to send ether to the Naxos contract. Please type in the amount of ETH you wish to contribute in the Paros Olympiad. </p>
